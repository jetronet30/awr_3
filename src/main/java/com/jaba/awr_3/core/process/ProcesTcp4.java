...
public class ProcesTcp4 {
    ...
    private int port;
    private final int scaleIndex = 9; // TcpService-ში პირველი TCP კონფიგურაციის ინდექსი (მუდმივი 9-ით)

    private static final Logger log = LoggerFactory.getLogger(ProcesTcp4.class);
