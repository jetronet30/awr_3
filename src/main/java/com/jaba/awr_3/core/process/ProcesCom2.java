...
public class ProcesCom2 {
    ...
    private int parity;
    private final int scaleIndex = 2; // ComService-ში პირველი პორტის ინდექსი (მუდმივი 2-ით)

    private static final Logger log = LoggerFactory.getLogger(ProcesCom2.class);
