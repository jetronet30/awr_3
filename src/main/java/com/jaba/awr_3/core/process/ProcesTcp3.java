...
public class ProcesTcp3 {
    ...
    private int port;
    private final int scaleIndex = 8; // TcpService-ში პირველი TCP კონფიგურაციის ინდექსი (მუდმივი 8-ით)

    private static final Logger log = LoggerFactory.getLogger(ProcesTcp3.class);
